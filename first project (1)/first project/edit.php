...
}else $msg ="Url is invalid. User id required in URL";
...
?>
        ...
        <?php include "inc_menus.php";?>
            <div id="msg" class="error"><?php if(!empty($msg)) echo $msg; ?></div>
        ...
        <?php if(empty($msg)){ ?>
            <form onsubmit="return validate()" name="form1" method="post" action="edit.php?id=<?php echo $_GET['id']; ?>">
                ...
                <label class="row">
                    ...
                    <input type="text" class="in1" maxlength="10" value="<?php echo isset($_POST['SENT']) && empty($okmsg) ? $_POST['mob1'] : $result['mobile1']; ?>" name="mob1">
                </label>
                <label class="row">
                    <span class="item">Mobile No 2</span>
                    <input type="text" class="in1" maxlength="10" value="<?php echo isset($_POST['SENT']) && empty($okmsg) ? $_POST['mob2'] : $result['mobile2']; ?>"  name="mob2">
                </label>
                <label class="row">
                    <span class="item">Land No</span>
                    <input type="text" class="in1" maxlength="10" value="<?php echo isset($_POST['SENT']) && empty($okmsg) ? $_POST['land'] : $result['land']; ?>"  name="land">
                </label>
                <label class="row">
