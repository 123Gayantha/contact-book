...
?>
        ...
        ?>
            ...
            @media screen and (max-width:580px) {
                .wrap{width:96%; margin: 10px 2%;}
                form{width:96%; padding: 50px 2%;}
            }
            ...
            @media screen and(max-width:320px) {
                .wrap{width:310px; margin:10px 5px;}
            }
        </style>
    </head>
    <body>
        ...
        <div class="wrap"  id="log"> 
            ...
            <div class="row">
                <input type="submit" class="in2" value="LOGIN" name="sent"> 
            </div>
            </form>
        ...
        <div class="wrap" id="reg"> 
            ...
            <form onsubmit="return validateRegister()" method="post" name="registerform">
                <label class="row">
                    ...
                    <input type="text" class="in1" required name="uname" max-length="20" value="<?php if(isset($_POST['uname'])) echo $_POST['uname']; ?>">
                </label>
            <label class="row">
                <span class="item">Email</span>
                <input type="email" class="in1" required name="email" max-length="60" value="<?php if(isset($_POST['email'])) echo $_POST['email']; ?>">
            </label>
            <label class="row">
                <span class="item">Password</span>
                <input type="password" class="in1" required name="passwd1" max-length="50">
            </label>
            <label class="row">
                <span class="item">Re-Enter Password</span>
                <input type="password" class="in1" required name="passwd2" max-length="50">
            </label>
            <div class="row">
                <input type="submit" class="in2" value="REGISTER" name="sent"> 
            </div>
            </form>
